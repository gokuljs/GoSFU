  ...
  return (
    <div className="flex min-h-svh flex-col items-center justify-center bg-[#0a0a0a] px-4">
      ...
      <div className="mt-10 flex flex-col items-center gap-4 sm:mt-14">
        <button
          onClick={onConnect}
          className="relative h-11 cursor-pointer rounded-full bg-linear-to-b from-white/90 to-white/70 px-10 text-sm font-semibold text-[#0a0a0a] shadow-[0_0_0_1px_rgba(255,255,255,0.1),0_2px_8px_rgba(0,0,0,0.4)] transition-all duration-300 hover:from-white hover:to-white/80 hover:shadow-[0_0_24px_rgba(255,255,255,0.12),0_0_0_1px_rgba(255,255,255,0.2)] active:scale-[0.97]"
        >
          Connect
        </button>
