...
description: This skill encodes Emil Kowalski's philosophy on UI polish, component design, animation decisions, and the invisible details that make software feel great. Use when building or reviewing frontend components, working with animations, CSS transitions, UI interactions, or when the user asks about design engineering, UI polish, component feel, or mentions Emil Kowalski or animations.dev.
---
